    ...
    try:
        while True:
            ...
            if opcion == "a":
                ...
                if trip_active:
                    print("Hay un viaje en curso. Finalizalo antes de apagar el Ta.")
                    continue
                ...
                logger.warning("Comando no reconocido: '%s'", opcion)  # detectar errores de tipeo o uso incorrectoen
